---
title: Graph Traversal and DAGs Interview
aliases: [Graph Traversal and DAGs Interview Questions]
track: 05-Algorithms
topic: graph-traversal-and-dags-interview
difficulty: intermediate
status: active
prerequisites: ["[[05-Algorithms/07-Graph-Traversal-and-DAGs/BFS|BFS]]"]
tags: [interviews, algorithms, graph-traversal-and-dags]
created: 2026-07-21
updated: 2026-07-21
---

# Graph Traversal and DAGs Interview
...
1. What **problem contract** does BFS expose (inputs, outputs, preconditions, postconditions)?
...
3. Walk a **correctness argument** for the core procedure in BFS (loop invariant, exchange argument, or optimal substructure).
...
5. Implement or extend **BFS/DFS, topological sort, and SCC labs** to pass a new shared vector scenario in [[05-Algorithms/code/README|code labs]].
...
- [[05-Algorithms/_exercises/Graph Traversal and DAGs Exercises.md|Graph Traversal and DAGs Exercises]]
