---
title: Shortest Paths Interview
aliases: [Shortest Paths Interview Questions]
track: 05-Algorithms
topic: shortest-paths-interview
difficulty: intermediate
status: active
prerequisites: ["[[05-Algorithms/08-Shortest-Paths/Shortest-Path Contracts and Relaxation|Shortest-Path Contracts and Relaxation]]"]
tags: [interviews, algorithms, shortest-paths]
created: 2026-07-21
updated: 2026-07-21
---

# Shortest Paths Interview
...
1. What **problem contract** does Shortest-Path Contracts and Relaxation expose (inputs, outputs, preconditions, postconditions)?
...
3. Walk a **correctness argument** for the core procedure in Shortest-Path Contracts and Relaxation (loop invariant, exchange argument, or optimal substructure).
...
5. Implement or extend **Dijkstra, Bellman-Ford, and Floyd-Warshall labs** to pass a new shared vector scenario in [[05-Algorithms/code/README|code labs]].
...
- [[05-Algorithms/_exercises/Shortest Paths Exercises.md|Shortest Paths Exercises]]
