---
title: MST and Connectivity Interview
aliases: [MST and Connectivity Interview Questions]
track: 05-Algorithms
topic: mst-and-connectivity-interview
difficulty: intermediate
status: active
prerequisites: ["[[05-Algorithms/09-MST-and-Connectivity/Minimum Spanning Tree Contracts and Cut Property|Minimum Spanning Tree Contracts and Cut Property]]"]
tags: [interviews, algorithms, mst-and-connectivity]
created: 2026-07-21
updated: 2026-07-21
---

# MST and Connectivity Interview
...
1. What **problem contract** does Minimum Spanning Tree Contracts and Cut Property expose (inputs, outputs, preconditions, postconditions)?
...
3. Walk a **correctness argument** for the core procedure in Minimum Spanning Tree Contracts and Cut Property (loop invariant, exchange argument, or optimal substructure).
...
5. Implement or extend **Kruskal, Prim, and bridge-finding labs** to pass a new shared vector scenario in [[05-Algorithms/code/README|code labs]].
...
- [[05-Algorithms/_exercises/MST and Connectivity Exercises.md|MST and Connectivity Exercises]]
