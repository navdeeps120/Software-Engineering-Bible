---
title: Dynamic Programming Interview
aliases: [Dynamic Programming Interview Questions]
track: 05-Algorithms
topic: dynamic-programming-interview
difficulty: intermediate
status: active
prerequisites: ["[[05-Algorithms/06-Dynamic-Programming/Optimal Substructure and Overlapping Subproblems|Optimal Substructure and Overlapping Subproblems]]"]
tags: [interviews, algorithms, dynamic-programming]
created: 2026-07-21
updated: 2026-07-21
---
...
1. What **problem contract** does Optimal Substructure and Overlapping Subproblems expose (inputs, outputs, preconditions, postconditions)?
...
3. Walk a **correctness argument** for the core procedure in Optimal Substructure and Overlapping Subproblems (loop invariant, exchange argument, or optimal substructure).
...
5. Implement or extend **knapsack, LCS/edit distance, and DAG DP labs** to pass a new shared vector scenario in [[05-Algorithms/code/README|code labs]].
...
- [[05-Algorithms/_exercises/Dynamic Programming Exercises.md|Dynamic Programming Exercises]]
