---
title: Sorting Interview
aliases: [Sorting Interview Questions]
track: 05-Algorithms
topic: sorting-interview
difficulty: intermediate
status: active
prerequisites: ["[[05-Algorithms/03-Sorting/Sorting Contracts Stability and Adaptivity|Sorting Contracts Stability and Adaptivity]]"]
tags: [interviews, algorithms, sorting]
created: 2026-07-21
updated: 2026-07-21
---
...
1. What **problem contract** does Sorting Contracts Stability and Adaptivity expose (inputs, outputs, preconditions, postconditions)?
...
3. Walk a **correctness argument** for the core procedure in Sorting Contracts Stability and Adaptivity (loop invariant, exchange argument, or optimal substructure).
...
5. Implement or extend **comparison sorts and counting/radix sort labs** to pass a new shared vector scenario in [[05-Algorithms/code/README|code labs]].
...
- [[05-Algorithms/_exercises/Sorting Exercises.md|Sorting Exercises]]
