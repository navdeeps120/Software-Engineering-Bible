---
title: Randomized Approximation and Online Interview
aliases: [Randomized Approximation and Online Interview Questions]
track: 05-Algorithms
topic: randomized-approximation-and-online-interview
difficulty: intermediate
status: active
prerequisites: ["[[05-Algorithms/12-Randomized-Approximation-and-Online/Randomized Algorithms and Reproducible RNG|Randomized Algorithms and Reproducible RNG]]"]
tags: [interviews, algorithms, randomized-approximation-and-online]
created: 2026-07-21
updated: 2026-07-21
---

# Randomized Approximation and Online Interview
...
1. What **problem contract** does Randomized Algorithms and Reproducible RNG expose (inputs, outputs, preconditions, postconditions)?
...
3. Walk a **correctness argument** for the core procedure in Randomized Algorithms and Reproducible RNG (loop invariant, exchange argument, or optimal substructure).
...
5. Implement or extend **reservoir sampling and randomized selection labs** to pass a new shared vector scenario in [[05-Algorithms/code/README|code labs]].
...
- [[05-Algorithms/_exercises/Randomized Approximation and Online Exercises.md|Randomized Approximation and Online Exercises]]
