---
title: MST and Connectivity Exercises
aliases: [MST and Connectivity Drills]
track: 05-Algorithms
topic: mst-and-connectivity-exercises
difficulty: intermediate
status: active
prerequisites: ["[[05-Algorithms/README|Algorithms]]"]
tags: [exercises, algorithms, mst-and-connectivity]
created: 2026-07-21
updated: 2026-07-21
---

# MST and Connectivity Exercises

Build Kruskal and Prim MSTs, apply cut/cycle properties, and detect bridges and articulation points.
...
**Prompt:** State the **problem contract** for the flagship algorithm in [[05-Algorithms/09-MST-and-Connectivity/Minimum Spanning Tree Contracts and Cut Property|Minimum Spanning Tree Contracts and Cut Property]]: inputs, outputs, preconditions, postconditions, and a certificate a verifier could check.

**Hint:** [[05-Algorithms/09-MST-and-Connectivity/Minimum Spanning Tree Contracts and Cut Property|Minimum Spanning Tree Contracts and Cut Property]].
...
**Prompt:** Compare two algorithms from [[05-Algorithms/09-MST-and-Connectivity/Kruskal with Union-Find|Kruskal with Union-Find]] and [[05-Algorithms/09-MST-and-Connectivity/Prim with Priority Queues|Prim with Priority Queues]] on the same workload. Tabulate time, space, and assumptions (input distribution, weight ranges, graph density).

**Hint:** [[05-Algorithms/09-MST-and-Connectivity/Kruskal with Union-Find|Kruskal with Union-Find]].
...
**Prompt:** Write a **loop invariant** or **exchange argument** sketch proving correctness for the core procedure in [[05-Algorithms/09-MST-and-Connectivity/Minimum Spanning Tree Contracts and Cut Property|Minimum Spanning Tree Contracts and Cut Property]]. Identify the maintenance step and termination measure.
...
**Prompt:** Prove or refute a claimed optimization from [[05-Algorithms/09-MST-and-Connectivity/Prim with Priority Queues|Prim with Priority Queues]]. If refuting, give a minimal counterexample; if proving, cite optimal substructure, cut property, or lower-bound argument as appropriate.

**Hint:** [[05-Algorithms/09-MST-and-Connectivity/Prim with Priority Queues|Prim with Priority Queues]].
...
**Prompt:** In [[05-Algorithms/code/README|code labs]], implement the Kruskal, Prim, and bridge-finding labs against shared JSON vectors. Preserve TS/Python parity and surface contract violations as typed errors.
...
**Prompt:** Extend the lab to handle an edge case documented in [[05-Algorithms/09-MST-and-Connectivity/Kruskal with Union-Find|Kruskal with Union-Find]] (e.g., duplicates, negative weights, unstable ties). Add regression vectors and update the public API contract.
...
**Prompt:** Reduce auxiliary space or preprocessing for the structure in [[05-Algorithms/09-MST-and-Connectivity/Prim with Priority Queues|Prim with Priority Queues]] while keeping the same asymptotic time. Prove the optimized version still satisfies the postcondition.
...
**Prompt:** A production trace shows wrong results on inputs allowed by [[05-Algorithms/09-MST-and-Connectivity/Minimum Spanning Tree Contracts and Cut Property|Minimum Spanning Tree Contracts and Cut Property]]. Write a minimal repro, identify the broken invariant, and patch with a regression vector.
...
**Prompt:** Review buggy reference code that passes happy-path vectors but fails an adversarial case from [[05-Algorithms/09-MST-and-Connectivity/Kruskal with Union-Find|Kruskal with Union-Find]]. Explain the failure mode and add debug-mode detection.
...
**Prompt:** Design a phased rollout replacing an incorrect algorithm (name a realistic failure from [[05-Algorithms/09-MST-and-Connectivity/Minimum Spanning Tree Contracts and Cut Property|Minimum Spanning Tree Contracts and Cut Property]] or [[05-Algorithms/09-MST-and-Connectivity/Kruskal with Union-Find|Kruskal with Union-Find]]) without a flag day. Include shadow reads, contract tests, and SLO gates.
...
- [[05-Algorithms/_interview/MST and Connectivity Interview.md|MST and Connectivity Interview]]
