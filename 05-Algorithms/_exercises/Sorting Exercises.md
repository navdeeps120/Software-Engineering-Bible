...
Implement and defend comparison and integer sorts under stability, adaptivity, and external constraints.
...
**Prompt:** State the **problem contract** for the flagship algorithm in [[05-Algorithms/03-Sorting/Sorting Contracts Stability and Adaptivity|Sorting Contracts Stability and Adaptivity]]: inputs, outputs, preconditions, postconditions, and a certificate a verifier could check.

**Hint:** [[05-Algorithms/03-Sorting/Sorting Contracts Stability and Adaptivity|Sorting Contracts Stability and Adaptivity]].
...
**Prompt:** Compare two algorithms from [[05-Algorithms/03-Sorting/Insertion and Selection Sort|Insertion and Selection Sort]] and [[05-Algorithms/03-Sorting/Merge Sort|Merge Sort]] on the same workload. Tabulate time, space, and assumptions (input distribution, weight ranges, graph density).

**Hint:** [[05-Algorithms/03-Sorting/Insertion and Selection Sort|Insertion and Selection Sort]].
...
**Prompt:** Write a **loop invariant** or **exchange argument** sketch proving correctness for the core procedure in [[05-Algorithms/03-Sorting/Sorting Contracts Stability and Adaptivity|Sorting Contracts Stability and Adaptivity]]. Identify the maintenance step and termination measure.
...
**Prompt:** Prove or refute a claimed optimization from [[05-Algorithms/03-Sorting/Merge Sort|Merge Sort]]. If refuting, give a minimal counterexample; if proving, cite optimal substructure, cut property, or lower-bound argument as appropriate.

**Hint:** [[05-Algorithms/03-Sorting/Merge Sort|Merge Sort]].
...
**Prompt:** In [[05-Algorithms/code/README|code labs]], implement the comparison sorts and counting/radix sort labs against shared JSON vectors. Preserve TS/Python parity and surface contract violations as typed errors.
...
**Prompt:** Extend the lab to handle an edge case documented in [[05-Algorithms/03-Sorting/Insertion and Selection Sort|Insertion and Selection Sort]] (e.g., duplicates, negative weights, unstable ties). Add regression vectors and update the public API contract.
...
**Prompt:** Reduce auxiliary space or preprocessing for the structure in [[05-Algorithms/03-Sorting/Merge Sort|Merge Sort]] while keeping the same asymptotic time. Prove the optimized version still satisfies the postcondition.
...
**Prompt:** A production trace shows wrong results on inputs allowed by [[05-Algorithms/03-Sorting/Sorting Contracts Stability and Adaptivity|Sorting Contracts Stability and Adaptivity]]. Write a minimal repro, identify the broken invariant, and patch with a regression vector.
...
**Prompt:** Review buggy reference code that passes happy-path vectors but fails an adversarial case from [[05-Algorithms/03-Sorting/Insertion and Selection Sort|Insertion and Selection Sort]]. Explain the failure mode and add debug-mode detection.
...
**Prompt:** Design a phased rollout replacing an incorrect algorithm (name a realistic failure from [[05-Algorithms/03-Sorting/Sorting Contracts Stability and Adaptivity|Sorting Contracts Stability and Adaptivity]] or [[05-Algorithms/03-Sorting/Insertion and Selection Sort|Insertion and Selection Sort]]) without a flag day. Include shadow reads, contract tests, and SLO gates.
...
- [[05-Algorithms/_interview/Sorting Interview.md|Sorting Interview]]
