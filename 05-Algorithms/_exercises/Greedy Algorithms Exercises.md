---
title: Greedy Algorithms Exercises
aliases: [Greedy Algorithms Drills]
track: 05-Algorithms
topic: greedy-algorithms-exercises
difficulty: intermediate
status: active
prerequisites: ["[[05-Algorithms/README|Algorithms]]"]
tags: [exercises, algorithms, greedy-algorithms]
created: 2026-07-21
updated: 2026-07-21
---
...
Apply exchange arguments, interval scheduling, Huffman coding, and recognize greedy failure modes.
...
**Prompt:** State the **problem contract** for the flagship algorithm in [[05-Algorithms/05-Greedy-Algorithms/Greedy Choice and Exchange Arguments|Greedy Choice and Exchange Arguments]]: inputs, outputs, preconditions, postconditions, and a certificate a verifier could check.

**Hint:** [[05-Algorithms/05-Greedy-Algorithms/Greedy Choice and Exchange Arguments|Greedy Choice and Exchange Arguments]].
...
**Prompt:** Compare two algorithms from [[05-Algorithms/05-Greedy-Algorithms/Interval Scheduling|Interval Scheduling]] and [[05-Algorithms/05-Greedy-Algorithms/Huffman Coding|Huffman Coding]] on the same workload. Tabulate time, space, and assumptions (input distribution, weight ranges, graph density).

**Hint:** [[05-Algorithms/05-Greedy-Algorithms/Interval Scheduling|Interval Scheduling]].
...
**Prompt:** Write a **loop invariant** or **exchange argument** sketch proving correctness for the core procedure in [[05-Algorithms/05-Greedy-Algorithms/Greedy Choice and Exchange Arguments|Greedy Choice and Exchange Arguments]]. Identify the maintenance step and termination measure.
...
**Prompt:** Prove or refute a claimed optimization from [[05-Algorithms/05-Greedy-Algorithms/Huffman Coding|Huffman Coding]]. If refuting, give a minimal counterexample; if proving, cite optimal substructure, cut property, or lower-bound argument as appropriate.

**Hint:** [[05-Algorithms/05-Greedy-Algorithms/Huffman Coding|Huffman Coding]].
...
**Prompt:** In [[05-Algorithms/code/README|code labs]], implement the interval scheduling and Huffman coding labs against shared JSON vectors. Preserve TS/Python parity and surface contract violations as typed errors.
...
**Prompt:** Extend the lab to handle an edge case documented in [[05-Algorithms/05-Greedy-Algorithms/Interval Scheduling|Interval Scheduling]] (e.g., duplicates, negative weights, unstable ties). Add regression vectors and update the public API contract.
...
**Prompt:** Reduce auxiliary space or preprocessing for the structure in [[05-Algorithms/05-Greedy-Algorithms/Huffman Coding|Huffman Coding]] while keeping the same asymptotic time. Prove the optimized version still satisfies the postcondition.
...
**Prompt:** A production trace shows wrong results on inputs allowed by [[05-Algorithms/05-Greedy-Algorithms/Greedy Choice and Exchange Arguments|Greedy Choice and Exchange Arguments]]. Write a minimal repro, identify the broken invariant, and patch with a regression vector.
...
**Prompt:** Review buggy reference code that passes happy-path vectors but fails an adversarial case from [[05-Algorithms/05-Greedy-Algorithms/Interval Scheduling|Interval Scheduling]]. Explain the failure mode and add debug-mode detection.
...
**Prompt:** Design a phased rollout replacing an incorrect algorithm (name a realistic failure from [[05-Algorithms/05-Greedy-Algorithms/Greedy Choice and Exchange Arguments|Greedy Choice and Exchange Arguments]] or [[05-Algorithms/05-Greedy-Algorithms/Interval Scheduling|Interval Scheduling]]) without a flag day. Include shadow reads, contract tests, and SLO gates.
...
- [[05-Algorithms/_interview/Greedy Algorithms Interview.md|Greedy Algorithms Interview]]
