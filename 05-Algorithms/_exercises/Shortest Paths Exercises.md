...
aliases: [Shortest Paths Drills]
track: 05-Algorithms
topic: shortest-paths-exercises
difficulty: intermediate
status: active
prerequisites: ["[[05-Algorithms/README|Algorithms]]"]
tags: [exercises, algorithms, shortest-paths]
created: 2026-07-21
updated: 2026-07-21
---
...
Implement relaxation-based shortest paths: Dijkstra, Bellman-Ford, 0-1 BFS, and Floyd-Warshall trade-offs.
...
**Prompt:** State the **problem contract** for the flagship algorithm in [[05-Algorithms/08-Shortest-Paths/Shortest-Path Contracts and Relaxation|Shortest-Path Contracts and Relaxation]]: inputs, outputs, preconditions, postconditions, and a certificate a verifier could check.

**Hint:** [[05-Algorithms/08-Shortest-Paths/Shortest-Path Contracts and Relaxation|Shortest-Path Contracts and Relaxation]].
...
**Prompt:** Compare two algorithms from [[05-Algorithms/08-Shortest-Paths/Dijkstra with Indexed Heaps|Dijkstra with Indexed Heaps]] and [[05-Algorithms/08-Shortest-Paths/Bellman-Ford and Negative Cycles|Bellman-Ford and Negative Cycles]] on the same workload. Tabulate time, space, and assumptions (input distribution, weight ranges, graph density).

**Hint:** [[05-Algorithms/08-Shortest-Paths/Dijkstra with Indexed Heaps|Dijkstra with Indexed Heaps]].
...
**Prompt:** Write a **loop invariant** or **exchange argument** sketch proving correctness for the core procedure in [[05-Algorithms/08-Shortest-Paths/Shortest-Path Contracts and Relaxation|Shortest-Path Contracts and Relaxation]]. Identify the maintenance step and termination measure.
...
**Prompt:** Prove or refute a claimed optimization from [[05-Algorithms/08-Shortest-Paths/Bellman-Ford and Negative Cycles|Bellman-Ford and Negative Cycles]]. If refuting, give a minimal counterexample; if proving, cite optimal substructure, cut property, or lower-bound argument as appropriate.

**Hint:** [[05-Algorithms/08-Shortest-Paths/Bellman-Ford and Negative Cycles|Bellman-Ford and Negative Cycles]].
...
**Prompt:** In [[05-Algorithms/code/README|code labs]], implement the Dijkstra, Bellman-Ford, and Floyd-Warshall labs against shared JSON vectors. Preserve TS/Python parity and surface contract violations as typed errors.
...
**Prompt:** Extend the lab to handle an edge case documented in [[05-Algorithms/08-Shortest-Paths/Dijkstra with Indexed Heaps|Dijkstra with Indexed Heaps]] (e.g., duplicates, negative weights, unstable ties). Add regression vectors and update the public API contract.
...
**Prompt:** Reduce auxiliary space or preprocessing for the structure in [[05-Algorithms/08-Shortest-Paths/Bellman-Ford and Negative Cycles|Bellman-Ford and Negative Cycles]] while keeping the same asymptotic time. Prove the optimized version still satisfies the postcondition.
...
**Prompt:** A production trace shows wrong results on inputs allowed by [[05-Algorithms/08-Shortest-Paths/Shortest-Path Contracts and Relaxation|Shortest-Path Contracts and Relaxation]]. Write a minimal repro, identify the broken invariant, and patch with a regression vector.
...
**Prompt:** Review buggy reference code that passes happy-path vectors but fails an adversarial case from [[05-Algorithms/08-Shortest-Paths/Dijkstra with Indexed Heaps|Dijkstra with Indexed Heaps]]. Explain the failure mode and add debug-mode detection.
...
**Prompt:** Design a phased rollout replacing an incorrect algorithm (name a realistic failure from [[05-Algorithms/08-Shortest-Paths/Shortest-Path Contracts and Relaxation|Shortest-Path Contracts and Relaxation]] or [[05-Algorithms/08-Shortest-Paths/Dijkstra with Indexed Heaps|Dijkstra with Indexed Heaps]]) without a flag day. Include shadow reads, contract tests, and SLO gates.
...
- [[05-Algorithms/_interview/Shortest Paths Interview.md|Shortest Paths Interview]]
