...
Together these define the **package contract**: what your code promises to consumers and what it depends on. This is distinct from how Node *runs* your code ([[06-NodeJS/README|Node.js]]) or how a bundler packs it ([[02-JavaScript/06-Modules-and-Tooling/Bundling Tree Shaking and Code Splitting|Bundling]]). Getting version ranges and lockfiles right is the difference between reproducible builds and "works on my machine" supply-chain incidents—closely tied to [[18-Security/README|Security]] and [[16-DevOps/README|DevOps]].
